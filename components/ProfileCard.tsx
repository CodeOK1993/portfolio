    ...
    <div className="profile h-full lg:w-[42rem] xl:w-[48rem] bg-gray-900 rounded-lg relative lg:block hidden">
      <div className="relative z-40 w-full h-full myShadow">
        ...
        {/* <div className="absolute bottom-0 left-0 flex w-full h-28 borderLeft customLine">
          <MyLink name="download cv" Icon={BsFillCloudArrowDownFill} url={`https://drive.google.com/file/d/1eS3FkHFgsbgZm2jyvfi6VDvY1mdEv3o7/view`} border />
          <MyLink name="my linkedin" Icon={AiFillLinkedin} url="https://www.linkedin.com/in/arthur-briggs" />
        </div> */}
      </div>
    </div>
  );
